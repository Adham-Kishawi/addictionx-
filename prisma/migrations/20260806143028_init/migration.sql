...
CREATE TABLE "newsletter_entries" (
    ...
    CONSTRAINT "newsletter_entries_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "newsletter_entries_email_key" ON "newsletter_entries"("email");
...
-- AddForeignKey
ALTER TABLE "newsletter_entries" ADD CONSTRAINT "newsletter_entries_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
