...
export const dictionary = {
  ar: {
    ...
    checkout: {
      ...
      paymentCopy: "نسخ",
      paymentCopied: "تم النسخ",
      amountToTransfer: "المبلغ المطلوب تحويله",
      stepsTitle: "خطوات الدفع",
      stepsInstapay: [
        "افتح تطبيق InstaPay على هاتفك",
        "أرسل المبلغ المطلوب إلى الحساب الموضح أعلاه",
        "تأكد من إرسال المبلغ الصحيح (المبلغ الظاهر أعلى النموذج)",
        "احتفظ برقم العملية / لقطة شاشة الإيصال",
        "ارفع الإيصال أو اكتب رقم العملية ثم أكمل تأكيد الطلب",
      ],
      stepsVodafone: [
        'افتح محفظة فودافون كاش من هاتفك (اطلب #9* ثم اختيار "تحويل")',
        "أرسل المبلغ المطلوب إلى الرقم الموضح أعلاه",
        "تأكد من إرسال المبلغ الصحيح (المبلغ الظاهر أعلى النموذج)",
        "احتفظ برقم العملية / لقطة شاشة الإيصال",
        "ارفع الإيصال أو اكتب رقم العملية ثم أكمل تأكيد الطلب",
      ],
      paymentStatusPending: "الدفع قيد المراجعة",
      paymentStatusPaid: "تم الدفع",
      paymentStatusFailed: "الدفع غير مكتمل",
      paymentStatusRefunded: "تم استرداد المبلغ",
      uploadReceipt: "رفع إيصال الدفع",
      uploadReceiptHint: "صورة واضحة للإيصال (اختياري)",
      uploadBadType: "يرجى رفع ملف صورة",
      uploadTooLarge: "حجم الملف يجب أن يكون أقل من 5 ميجابايت",
      uploadAlt: "معاينة الإيصال",
      uploadClick: "اضغط للرفع",
      uploadDragDrop: "أو اسحب وأفلت",
    ...
    account: {
      ...
      passwordRateLimited: "محاولات كثيرة — انتظر 15 دقيقة قبل إعادة المحاولة",
      wishlist: "المفضلة",
      ...
      trackBosta: "تتبع شحنة Bosta",
      trackAramex: "تتبع شحنة Aramex",
    ...
    admin: {
      ...
      noActiveProductsForOrder: "لا توجد منتجات نشطة لإنشاء طلب يدوي",
      ...
      uploadBadType: "نوع الملف غير مدعوم — استخدم JPG أو PNG أو WebP أو GIF",
      uploadBadSize: "الصورة كبيرة جدًا — الحد الأقصى 5MB",
      imageRequired: "مطلوب: ارفع صورة لهذه المجموعة",
      ...
      noVariantsHint:
        "بدون مقاسات: يُباع المنتج بسعر الأساس (المخزون على مستوى المنتج أدناه)",
      productStock: "مخزون المنتج (بدون مقاسات)",
      ...
      productBasicInfo: "البيانات الأساسية",
      productDescription: "الوصف",
      productPricing: "التسعير",
      productFlags: "خصائص العرض",
      productNotes: "ملاحظات الزجاجة",
      productDesign: "ألوان التصميم",
      charactersCount: "حرف",
      id: "المعرّف",
      coupons: "الكوبونات",
      settings: "الإعدادات",
      ...
      shippingDesc: "تحكم في رسوم التوصيل والمناطق المتاحة للتسليم",
      shippingSettingsDesc: "الرسوم الافتراضية وحد الشحن المجاني",
  ...
  en: {
    ...
    checkout: {
      ...
      stepsInstapay: [
        "Open the InstaPay app on your phone",
        "Send the required amount to the account shown above",
        "Double-check you send the exact amount shown at the top",
        "Keep the transaction number / receipt screenshot",
        "Upload the receipt or enter the transaction number, then confirm the order",
      ],
      stepsVodafone: [
        "Open Vodafone Cash from your phone (*9# then choose Transfer)",
        "Send the required amount to the number shown above",
        "Double-check you send the exact amount shown at the top",
        "Keep the transaction number / receipt screenshot",
        "Upload the receipt or enter the transaction number, then confirm the order",
      ],
      paymentStatusPending: "Payment pending verification",
      paymentStatusPaid: "Payment received",
      paymentStatusFailed: "Payment not completed",
      paymentStatusRefunded: "Amount refunded",
      uploadReceipt: "Upload Payment Receipt",
      uploadReceiptHint: "Clear photo of receipt (optional)",
      uploadBadType: "Please upload an image file",
      uploadTooLarge: "File size must be less than 5MB",
      uploadAlt: "Receipt preview",
    ...
    account: {
      ...
      passwordRateLimited: "Too many attempts — wait 15 minutes and try again",
      wishlist: "Wishlist",
      ...
      trackBosta: "Track Bosta Shipment",
      trackAramex: "Track Aramex Shipment",
    ...
    admin: {
      ...
      noActiveProductsForOrder:
        "No active products available for a manual order",
      ...
      noImage: "No image",
      uploadDrop: "Drop a picture here or click to browse",
      uploadBadType: "Unsupported file type — use JPG, PNG, WebP or GIF",
      uploadBadSize: "Image is too large — maximum 5MB",
      imageRequired: "Required: upload a picture for this collection",
      ...
      noVariantsHint:
        "No sizes: sold at the base price (stock is at the product level below)",
      productStock: "Product stock (no sizes)",
      ...
      productFlags: "Display Options",
      productNotes: "Bottle Notes",
      productDesign: "Design Colors",
      ...
      shippingDesc:
        "Control delivery fees and the zones available for delivery",
      shippingSettingsDesc: "Default fee and free-shipping threshold",
      ...
      instapayPhone: "InstaPay Phone Number",
      vodafoneCashNumber: "Vodafone Cash Number",
      vodafoneCashName: "Vodafone Cash Account Name",
      vodafoneCashNameAr: "Account Name (Arabic)",
      vodafoneCashNameEn: "Account Name (English)",
      ...
      adminNotificationEmail: "Store Notification Email",
      adminNotificationEmailHint:
