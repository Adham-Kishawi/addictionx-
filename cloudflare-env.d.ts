/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 6583187b32e0ee232b5bcea80a3379d4)
// Runtime types generated with workerd@1.20260811.1 2026-08-17 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	HYPERDRIVE: Hyperdrive;
	ASSETS: Fetcher;
	NEXT_PUBLIC_SITE_URL: "https://addictionx.store";
	EMAIL_FROM: "ADDICTIONX <hello@addictionx.store>";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "EMAIL_FROM">> {}
}
